...
namespace TwoMoons\DataResolver;
...
#[Package('inventory')]
class TwoMoonsSliderCmsElementResolver extends AbstractCmsElementResolver
{
    private const PRODUCT_SLIDER_ENTITY_FALLBACK = 'twomoons-slider-entity-fallback';
    private const STATIC_SEARCH_KEY = 'twomoons-slider';
    ...
    public function collect(CmsSlotEntity $slot, ResolverContext $resolverContext): ?CriteriaCollection
    {
        ...
        if ($collection) {
            foreach ($collection as $productCriteria) {
