...
async function createWrapper(customCmsElementConfig) {
    return mount(await wrapTestComponent('sw-cms-el-config-twslider', {
        sync: true,
    }), {
        props: {
            element: {
...
describe('module/sw-cms/elements/product-slider/config', () => {
    ...
    it('should render product assignment type select', async () => {
        ...
        expect(wrapper.find('.sw-cms-el-config-twslider__product-assignment-type-select')
            .exists()).toBeTruthy();
    });
    ...
    it('should render manual product assignment by default', async () => {
        ...
        expect(wrapper.find('.sw-cms-el-config-twslider__products').exists()).toBeTruthy();
    });
    ...
    it('should render product stream selection when element product type is "product_stream"', async () => {
        ...
        expect(wrapper.find('.sw-cms-el-config-twslider__product-stream-select').exists()).toBeTruthy();

        // Performance hint should exist
        expect(wrapper.find('.sw-cms-el-config-twslider__product-stream-performance-hint')
            .exists()).toBeTruthy();

        // Sorting fields should exist
        expect(wrapper.find('.sw-cms-el-config-twslider__product-stream-sorting').exists()).toBeTruthy();
        expect(wrapper.find('.sw-cms-el-config-twslider__product-stream-limit').exists()).toBeTruthy();
    });
    ...
    it('should render product stream preview modal', async () => {
        ...
        expect(wrapper.find('.sw-cms-el-config-twslider__product-stream-preview-modal')
            .exists()).toBeTruthy();
